...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig dBFavoritesDaoConfig;
    ...
    private final DBFavoritesDao dBFavoritesDao;
    ...
    public DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        dBFavoritesDaoConfig = daoConfigMap.get(DBFavoritesDao.class).clone();
        dBFavoritesDaoConfig.initIdentityScope(type);
        ...
        dBFavoritesDao = new DBFavoritesDao(dBFavoritesDaoConfig, this);
        ...
        registerDao(DBFavorites.class, dBFavoritesDao);
    ...
    public void clear() {
        ...
        dBFavoritesDaoConfig.getIdentityScope().clear();
        dBSwitchDaoConfig.getIdentityScope().clear();
    }
    ...
    public DBFavoritesDao getDBFavoritesDao() {
